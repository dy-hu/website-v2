...
import { Home, User, Briefcase, Mail, Github, Linkedin, Twitter, FileText, Question, Phone, Palette } from 'lucide-react'
   ...
   <ResponsiveComponent>

    {
        ...
        target={newTab ? '_blank' : '_self'}>
            <span className='relative md:w-20 md:h-20 sm:w-16 sm:h-16 xs:w-14 xs:h-14 md:p-5 xs:p-4 animate-spin-slow-reverse group-hover:pause hover:text-accent'>
                {getIcon(icon)}
